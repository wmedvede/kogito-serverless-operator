...
func main() {
	...
	if utils.IsKnativeServing() {
		...
		if knativeServingClient, err = knative.NewKnativeServingClient(mgr.GetConfig()); err != nil {
			if err != nil {
	...
	if utils.IsKnativeEventing() {
		...
		if knativeEventingClient, err = knative.NewKnativeEventingClient(mgr.GetConfig()); err != nil {
			if err != nil {
